document.addEventListener("DOMContentLoaded", function() {
    ...
    const semuaElemenIklan = document.querySelectorAll(".iklanan");
        ...
        const iklanHorizontal = [
			...
			[`<a href="https://indodax.com/ref/Swordofgod/1" target="_blank"> <img src="https://swrdfgd.github.io/indodax/horizontal-688x384.jpg" alt="Indodax Banner" width="344" height="192" style="border: none;" /> </a>`,
			`<a href="https://indodax.com/ref/Swordofgod/1" target="_blank"> <img src="https://swrdfgd.github.io/indodax/persegi-512x512.jpg" alt="Indodax Banner" width="256" height="256" style="border: none;" /> </a>`,
			],
			[`<a href="https://claimfreecoins.io/zcash-faucet/?r=syaiftheoplover1925@gmail.com" target="_blank" style="display: flex; flex-direction: column; width: 250px; height: 250px; text-decoration: none; border: 1px solid #e0e0e0; font-family: 'Segoe UI', Arial, sans-serif; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden; transition: transform 0.2s ease-in-out;" onmouseover="this.style.transform='scale(1.02)';" onmouseout="this.style.transform='scale(1)';"> <div style="background-color: #000000; color: #ffffff; height: 45%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 10px;"> <span style="font-size: 24px; font-weight: bold; line-height: 1.2;">Free Zcash<br>Faucet</span> </div> <div style="background-color: #ffffff; color: #333333; height: 55%; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 15px; box-sizing: border-box;"> <span style="font-size: 18px; font-weight: 800; color: #f4b728; margin-bottom: 8px; text-transform: uppercase;">Claim Now</span> <span style="font-size: 12px; color: #666666; margin-bottom: 12px;">Get free Zcash directly to your crypto wallet!</span> <span style="background-color: #f4b728; color: #000000; padding: 6px 16px; border-radius: 20px; font-size: 13px; font-weight: bold;">Claim Here &rarr;</span> </div> </a>`,
			],
			[`<a href="https://earncryptowrs.in/?r=1343" target="_blank" style="display: flex; flex-direction: column; width: 250px; height: 250px; text-decoration: none; border: 1px solid #e0e0e0; font-family: 'Segoe UI', Arial, sans-serif; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden; transition: transform 0.2s ease-in-out;" onmouseover="this.style.transform='scale(1.02)';" onmouseout="this.style.transform='scale(1)';"> <div style="background-color: #000000; color: #ffffff; height: 45%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 10px;"> <span style="font-size: 24px; font-weight: bold; line-height: 1.2;">Free Dash<br>Faucet</span> </div> <div style="background-color: #ffffff; color: #333333; height: 55%; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 15px; box-sizing: border-box;"> <span style="font-size: 18px; font-weight: 800; color: #f4b728; margin-bottom: 8px; text-transform: uppercase;">Claim Now</span> <span style="font-size: 12px; color: #666666; margin-bottom: 12px;">Get free Dash directly to your crypto wallet!</span> <span style="background-color: #f4b728; color: #000000; padding: 6px 16px; border-radius: 20px; font-size: 13px; font-weight: bold;">Claim Here &rarr;</span> </div> </a>`,
			`<a href="https://earncryptowrs.in/?r=1343" target="_blank" style="display: flex; flex-direction: column; width: 250px; height: 250px; text-decoration: none; border: 1px solid #e0e0e0; font-family: 'Segoe UI', Arial, sans-serif; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden; transition: transform 0.2s ease-in-out;" onmouseover="this.style.transform='scale(1.02)';" onmouseout="this.style.transform='scale(1)';"> <div style="background-color: #000000; color: #ffffff; height: 45%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 10px;"> <span style="font-size: 24px; font-weight: bold; line-height: 1.2;">Free USDT<br>Faucet</span> </div> <div style="background-color: #ffffff; color: #333333; height: 55%; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 15px; box-sizing: border-box;"> <span style="font-size: 18px; font-weight: 800; color: #f4b728; margin-bottom: 8px; text-transform: uppercase;">Claim Now</span> <span style="font-size: 12px; color: #666666; margin-bottom: 12px;">Get free USDT directly to your crypto wallet!</span> <span style="background-color: #f4b728; color: #000000; padding: 6px 16px; border-radius: 20px; font-size: 13px; font-weight: bold;">Claim Here &rarr;</span> </div> </a>`,
			],
			[`https://althub.club/cdn/img/ad728x90.png`,
			],
			[`<div style="width: 320px; height: 320px; background: linear-gradient(135deg, #e52d27, #b31217); color: #ffffff; border-radius: 16px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 25px; box-sizing: border-box; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2); font-family: Arial, sans-serif; margin: 10px auto;"> <h3 style="margin: 0; font-size: 16px; color: #ffde00; text-transform: uppercase; letter-spacing: 2px;">Hadiah TUNAI</h3> <div style="font-size: 42px; font-weight: 900; margin: 10px 0; line-height: 1.1; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">Rp270rb lagi menunggumu!<br></div> <p style="font-size: 14px; margin: 0 0 20px 0; color: #f8f8f8; line-height: 1.4;">Jangan lewatkan kesempatan emas ini. Klaim Sekarang.</p> <a href="https://vpkami.com/uscSc" target="_blank" style="display: inline-block; background-color: #ffde00; color: #b31217; font-size: 16px; font-weight: bold; text-decoration: none; padding: 12px 25px; border-radius: 30px; transition: all 0.3s ease; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);" onmouseover="this.style.transform='scale(1.05)'; this.style.backgroundColor='#fff200'; this.style.boxShadow='0 6px 15px rgba(0, 0, 0, 0.4)';" onmouseout="this.style.transform='scale(1)'; this.style.backgroundColor='#ffde00'; this.style.boxShadow='0 4px 10px rgba(0, 0, 0, 0.3)';"> KLIK DI SINI </a> </div>`,
			`<div style="width: 320px; height: 320px; background: linear-gradient(135deg, #e52d27, #b31217); color: #ffffff; border-radius: 16px; display: flex; flex-direction: column; justify-content: center; align-items: center; text-align: center; padding: 25px; box-sizing: border-box; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.2); font-family: Arial, sans-serif; margin: 10px auto;"> <h3 style="margin: 0; font-size: 16px; color: #ffde00; text-transform: uppercase; letter-spacing: 2px;">Hai bestie, ada aplikasi Easycash untuk solusi keuanganmu nih!</h3> <div style="font-size: 42px; font-weight: 900; margin: 10px 0; line-height: 1.1; text-shadow: 2px 2px 4px rgba(0,0,0,0.3);">Dana siap cair sekarang hingga Rp50 JUTA.<br></div> <p style="font-size: 14px; margin: 0 0 20px 0; color: #f8f8f8; line-height: 1.4;">Yuk cek aplikasi untuk dapat hadiah tunai GRATIS Rp70 RIBU. Di Easycash, bunga harian rendah banget dan tenor pembayaran panjang lho! Tunggu apalagi? </p> <a href="https://web.easycash.id/webview/activity/register-human-v2?code=KlPP9QSL&v=tab" target="_blank" style="display: inline-block; background-color: #ffde00; color: #b31217; font-size: 16px; font-weight: bold; text-decoration: none; padding: 12px 25px; border-radius: 30px; transition: all 0.3s ease; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);" onmouseover="this.style.transform='scale(1.05)'; this.style.backgroundColor='#fff200'; this.style.boxShadow='0 6px 15px rgba(0, 0, 0, 0.4)';" onmouseout="this.style.transform='scale(1)'; this.style.backgroundColor='#ffde00'; this.style.boxShadow='0 4px 10px rgba(0, 0, 0, 0.3)';"> KLIK DI SINI </a> </div>`,
			],
        ];
        ...
        const iklanVertikal = [
			...
			[`<a href="https://indodax.com/ref/Swordofgod/1" target="_blank"> <img src="https://swrdfgd.github.io/indodax/vertikal-384x688.jpg" alt="Indodax Banner" width="192" height="344" style="border: none;" /> </a>`,
			`<a href="https://indodax.com/ref/Swordofgod/1" target="_blank"> <img src="https://swrdfgd.github.io/indodax/persegi-512x512.jpg" alt="Indodax Banner" width="256" height="256" style="border: none;" /> </a>`,
			],
			[`<a href="https://claimfreecoins.io/zcash-faucet/?r=syaiftheoplover1925@gmail.com" target="_blank" style="display: flex; flex-direction: column; width: 250px; height: 250px; text-decoration: none; border: 1px solid #e0e0e0; font-family: 'Segoe UI', Arial, sans-serif; box-shadow: 0 4px 6px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden; transition: transform 0.2s ease-in-out;" onmouseover="this.style.transform='scale(1.02)';" onmouseout="this.style.transform='scale(1)';"> <div style="background-color: #000000; color: #ffffff; height: 45%; display: flex; align-items: center; justify-content: center; text-align: center; padding: 10px;"> <span style="font-size: 24px; font-weight: bold; line-height: 1.2;">Free Zcash<br>Faucet</span> </div> <div style="background-color: #ffffff; color: #333333; height: 55%; display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 15px; box-sizing: border-box;"> <span style="font-size: 18px; font-weight: 800; color: #f4b728; margin-bottom: 8px; text-transform: uppercase;">Claim Now</span> <span style="font-size: 12px; color: #666666; margin-bottom: 12px;">Get free Zcash directly to your crypto wallet!</span> <span style="background-color: #f4b728; color: #000000; padding: 6px 16px; border-radius: 20px; font-size: 13px; font-weight: bold;">Claim Here &rarr;</span> </div> </a>`,
			],
